...
import fgt.gameserver.enums.skills.SkillOpType;
...
import fgt.gameserver.model.actor.instance.Cubic;
import fgt.gameserver.model.actor.instance.Door;
import fgt.gameserver.model.actor.instance.SiegeFlag;
...
public abstract class L2Skill implements IChanceSkillTrigger
{
	...
	{
		if (getSkillType().equals(SkillType.BUFF))
		{
			return true;
		}
		return false;
